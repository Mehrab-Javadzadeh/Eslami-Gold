...
const CONTACT_METHODS = [
  {
    key: "telegram",
    label: "تلگرام",
    caption: "پاسخ‌گویی سریع پیام‌ها",
    href: "https://t.me/Eslamigoldadmin",
    handle: "@Eslamigoldadmin",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7">
        <path d="M21.05 3.16 2.7 10.53c-1.24.5-1.23 1.2-.23 1.5l4.7 1.47 1.8 5.56c.22.6.37.85.76.85.3 0 .43-.14.6-.3l2.02-1.95 4.2 3.1c.77.43 1.33.2 1.53-.7l2.77-13.06c.3-1.1-.42-1.6-1.14-1.34ZM8.6 13.9l9-5.6c.42-.26.8-.12.5.16l-7.5 6.8-.29 3.1-1.71-4.46Z" />
      </svg>
    ),
  },
  {
